  		    ...
  		    <div class="navbar-inner">
  		        <div class="container">
  		            ...
  		            <div class="nav-collapse collapse">
  		                <ul class="nav">
  		                    <li class="active"><a rel="tooltip" data-placement="bottom" title="Home" id="home"
  		                            href="index.php"></i>&nbsp;Home</a> </li>

  		                    <li class="">
  		                        <a rel="tooltip" data-placement="bottom" title="About Us" id="login"
